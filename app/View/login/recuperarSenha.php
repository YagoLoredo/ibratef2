...
<?php 
// 1. Recupera os dados da sessão que enviamos do Controller
$dados = $_SESSION['dados_recupera'] ?? null;

// 2. Separa as variáveis com segurança. Se não existirem, ficam em branco.
$id                      = $dados['id'] ?? '';
$usuariorecuperasenha_id = $dados['usuariorecuperasenha_id'] ?? '';
$nome                    = $dados['nome'] ?? '';

// 3. Limpa o lixo da sessão para não acumular na memória do navegador
unset($_SESSION['dados_recupera']); 
?>
